...
const Blogs = () => {
  ...
  useEffect(() => {
    const getAllPublishedBlogs = async () => {
      try {
        const res = await axios.get(`https://blog-yt-wau1.onrender.com//blog/get-published-blogs`, { withCredentials: true })
        if (res.data.success) {
  ...
  return (
    <div className='pt-16  bg-gray-500 text-white p-10 '>
