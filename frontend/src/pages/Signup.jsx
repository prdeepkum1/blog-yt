    ...
    <div className="flex h-screen md:pt-14 md-h-[760px]">
      ...
      <div className='flex justify-center items-center flex-1 px-4 md:px-0'>
        <Card className="w-full max-w-md p-6 shadow-lg rounded-2xl dark:bg-gray-800 dark:border-gray-600 ">
          <CardHeader>
            <CardTitle>
              <h1 className="text-center text-kl front-semibold">Create an account</h1>
            </CardTitle>
          ...
          <CardContent>
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div className="flex gap-5">
                <div>
                  ...
                  <Input type="text" placeholder="First Name"
                    name="firstName" className="dark:border-gray-600 dark:bg-gray-900"
                ...
                <div>
                  ...
                  <Input type="text" placeholder="Last Name"
                    name="lastName" className="dark:border-gray-600 dark:bg-gray-900"
                    value={user.lastName}
                    onChange={handleChange}
                  />
                </div>
              ...
              <p className="text-center text-gray-600 dark:text-gray-300">Already have an account? <Link to={'/login'}> <span className="underline 
              cursor-pointer hover:text-gray-800 dark:hover:text-gray-100">Sign in</span></Link></p>
            </form>
          </CardContent>
